        ...
        <nav class="navbar navbar-default" role="navigation">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="${pageContext.request.contextPath}/goodsrecommend_list?type=2" <c:if test="${param.flag==3&&type==2}">class="active"</c:if>>热销</a></li>
                    <li><a href="${pageContext.request.contextPath}/goodsrecommend_list?type=3" <c:if test="${param.flag==3&&type==3}">class="active"</c:if>>新品</a></li>

                    <c:choose>
                        <c:when test="${empty user}">
                            <li><a href="${pageContext.request.contextPath}/user_register.jsp" <c:if test="${param.flag==5}">class="active"</c:if>>注册</a></li>
                            <li><a href="${pageContext.request.contextPath}/user_login.jsp" <c:if test="${param.flag==6}">class="active"</c:if>>登录</a></li>
                        </c:when>
                        <c:otherwise>
        ...
        <div class="header-info">
            ...
            <div class="header-right cart">
                <a href="${pageContext.request.contextPath}/goods_cart.jsp">
                    <span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"><span class="card_num"><c:if test="${order.amount!=0}">${order.amount}</c:if></span></span>
                </a>
            </div>
